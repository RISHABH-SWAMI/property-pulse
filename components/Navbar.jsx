          ...
          <div className='relative flex h-20 items-center justify-between'>
            ...
            <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
              ...
              <Link href="/" className='flex flex-shrink-0 items-center'>
                <Image className='h-10 w-auto rounded-full ' src={logo} alt='PropertyPulse' />
                  ...
                  </Link>
                  {
                    session && (
                      <>
                        <Link
                          href='/properties/add'
                          className={` ${pathname === "/properties/add-property" ? "bg-black" : ""} text-white hover:bg-gray-900 hover:text-white rounded-md px-3 py-2`}
